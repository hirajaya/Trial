...
const Post = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">Create Post</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-grow space-y-4">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
              {imageUrl ? (
                <img src={imageUrl} alt="Uploaded" className="max-w-full h-24 object-cover rounded-lg" />
              ) : (
                <div>
            ...
            <textarea
              ...
              className="w-full p-3 border border-gray-300 rounded-lg h-24 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
              value={content}
